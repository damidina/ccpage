...
Currency.convertAll = function(oldCurrency, newCurrency, selector, format, shopCurrency) {
  jQuery(selector || 'span.money').each(function() {
    ...
    if (jQuery(this).attr('data-currency-'+newCurrency)) {
      ...
      console.log(`converting ${jQuery(this)} for the first time!`);
      ...
      if (jQuery(this).attr('data-currency') == null) {
        console.log(`${jQuery(this)} did not have a data-currency attr.`);
  ...
  this.cookie.write(newCurrency); // changed from this to the Currency object
};